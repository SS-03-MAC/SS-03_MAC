...
///
/// \file
/// This file contains the implementation of SHA2-384, an instance of a
...
uint64_t sha2_384::ch(uint64_t x, uint64_t y, uint64_t z) { return (x & y) ^ ((~x) & z); }
...
void sha2_384::init() {
  ...
  this->h[0] = 0xcbbb9d5dc1059ed8ll;
  this->h[1] = 0x629a292a367cd507ll;
  this->h[2] = 0x9159015a3070dd17ll;
  this->h[3] = 0x152fecd8f70e5939ll;
  this->h[4] = 0x67332667ffc00b31ll;
  this->h[5] = 0x8eb44a8768581511ll;
  this->h[6] = 0xdb0c2e0d64f98fa7ll;
  this->h[7] = 0x47b5481dbefa4fa4ll;
