...
///
/// \file
/// This file contains the implementation of SHA2-256, an instance of a
...
uint32_t sha2_256::ch(uint32_t x, uint32_t y, uint32_t z) { return (x & y) ^ ((~x) & z); }

uint32_t sha2_256::mj(uint32_t x, uint32_t y, uint32_t z) { return (x & y) ^ (x & z) ^ (y & z); }

uint32_t sha2_256::bsig0(uint32_t x) { return edutls_rotr32(x, 2) ^ edutls_rotr32(x, 13) ^ edutls_rotr32(x, 22); }

uint32_t sha2_256::bsig1(uint32_t x) { return edutls_rotr32(x, 6) ^ edutls_rotr32(x, 11) ^ edutls_rotr32(x, 25); }

uint32_t sha2_256::ssig0(uint32_t x) { return edutls_rotr32(x, 7) ^ edutls_rotr32(x, 18) ^ (x >> 3); }

uint32_t sha2_256::ssig1(uint32_t x) { return edutls_rotr32(x, 17) ^ edutls_rotr32(x, 19) ^ (x >> 10); }
...
void sha2_256::digest(uint8_t *output) {
