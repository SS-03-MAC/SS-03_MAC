/*
 * BER encoding standard per ISO_IEC_8825-1_2015.
*/

#pragma once
#ifndef SYMBOL
#define ENCODINGS_SRC_LIB_BER_H__
...
#define BER_LENGTH_DEFINITE_SHORT_VALUE_MASK BER_BIT7 + BER_BIT6 + BER_BIT5 + BER_BIT4 + BER_BIT3 + BER_BIT2 + BER_BIT1;
...
#define BER_VALUE_ENUMERATED_ID 0x0A;

#endif /* end of include guard: ENCODINGS_SRC_LIB_BER_H__ */
